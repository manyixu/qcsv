...
public class CSVImportUtil {
    ...
    public static<T> List<T> importCSV(File file,Class<?> clazz,Charset charset){
        CSVImporter csvImporter = new CSVImporter<>(clazz);
        return csvImporter.importCSV(file,charset);
    }

    public static<T> List<T> importCSV(File file,Class<?> clazz,Charset charset,CSVFormat csvFormat){
        CSVImporter csvImporter = new CSVImporter<>(clazz);
